...
Original file is located at
    https://colab.research.google.com/drive/1WpkIb8i_V4QyMkxocwCdlwieynI5Duap
...
# Read in dataset
import pandas as pd
apps_with_duplicates = pd.read_csv('datasets/2c_apps.csv')
...
# Plot size vs. rating
plt1 = sns.jointplot(data=apps, x = large_categories['Size'], y = large_categories['Rating'])
...
reviews_df = pd.read_csv('datasets/2d_user_reviews.csv')
